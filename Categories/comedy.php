...
$query1 = "SELECT * FROM `vhs` WHERE `category` = 'Comedy' AND `type` = 'VHS'";
$query2 = "SELECT * FROM `dvd` WHERE `category` = 'Comedy' AND `type` = 'DVD'";
...
<body>
<h2 style="text-align: center">Category: Comedy <a href="../categories.php">
